...
function getWeather() {
    ...
    if(city != '') {
        $.ajax({
            url: 'http://api.openweathermap.org/data/2.5/weather?q=' + city + "&units=metric" + "&APPID=5d6bc9e51e2930ebb36bcdd58dd827f0",
            type: "GET",
            dataType: "jsonp",
            success: function(data) {
                var widget = showResults(data)
                /* console.log(data); Testing for data objects existence under console*/  
